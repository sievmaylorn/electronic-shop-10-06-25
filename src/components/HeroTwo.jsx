    ...
    <div>
          <div className='w-full h-[70vh] bg2-img'>
            <div className='container h-full px-4 lg:px-[128px] mx-auto flex items-center justify-end'>
                 <div className='w-full md:w-[65%] md:h-[35vh] lg:w-[45%] lg:h-[50vh] bg-pink-500 p-8'>
                     ...
                     <button className='px-10 py-3 bg-white  duration-300 ease-in-out rounded-4xl cursor-pointer mt-5 text-3xl '>
                             Learn More
                     </button>
                  </div>                 
