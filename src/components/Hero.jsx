            ...
            <div className='container h-full px-4 lg:px-[128px] mx-auto
                 ...
                 <div className='w-full md:w-[60-%] lg:w-[38%]'>
                      <h1 className='text-4xl text-white md:text-6xl font-bold'>
                          ...
                          <span  className='text-blue-600'>Books-Store.</span>
                      </h1>
                      ...
                      <button className='px-10 text-white py-3 bg-blue-700 rounded-4xl cursor-pointer mt-5 text-2xl hover:bg-blue-600 '>
                          Learn More
                      </button>
                  </div>                 
